  ...
  <body>
    ...
    <form method='post' action="setEmptySKUsSubmit.php">
      ...
      <table class='pure-table pure-table-horizontal'>
        <thead><tr><td>Name</td><td>SKU</td><td>MAP</td><td>Min Inv</td></tr></thead>
      </table>
    </div>
      ...
      <table>
        <?php
          ...
          foreach ($SKUs as $product) {
            ...
            echo ("<tr><td>" . $product['brand'] . " " . $product['name'] . "</td><td>" . "<input type='text' name='" . $product['id'] . "'></input>" . "</td><td>" . $product['MAP'] . "</td><td>" . $product['minInv'] . "</td></tr>");
          }
